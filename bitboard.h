...
public:
  ...
  bool can_white_castle_king_side =
      false; // stores whether white can castle king side
  bool can_white_castle_queen_side =
      false; // stores whether white can castle queen side
  bool can_black_castle_king_side =
      false; // stores whether black can castle king side
  bool can_black_castle_queen_side =
      false;              // stores whether black can castle queen side
  int halfmove_clock = 0; // stores the number of halfmoves since the last
  ...
  inline int get_piece_on_square(int square) const {
  ...
  // Generate Zobrist hash key from scratch

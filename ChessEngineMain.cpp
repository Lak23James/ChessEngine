...
std::string move_to_string(uint16_t move) {
    ...
    switch (flags) {
        ...
        case PROMOTION_CAPTURE_KNIGHT: result += 'n'; break;
        case PROMOTION_CAPTURE_BISHOP: result += 'b'; break;
        case PROMOTION_CAPTURE_ROOK:   result += 'r'; break;
        case PROMOTION_CAPTURE_QUEEN:  result += 'q'; break;
        default: break;
    }
    return result;
}
